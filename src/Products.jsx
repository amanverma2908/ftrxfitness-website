    ...
    <>
      <div class="container px-6 py-10 mx-auto">
        ...
        <p class="max-w-2xl mx-auto mt-6 text-center text-gray-500">
          In the process of getting healthy and fit we recommend you some
          supplies that will provide energy and boost your performance and keep
          you energetic during sessions.
        </p>
      </div>
